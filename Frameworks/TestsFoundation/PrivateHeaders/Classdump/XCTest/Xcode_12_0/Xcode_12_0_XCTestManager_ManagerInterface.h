...
#endif
#import "Xcode_12_0_XCTestManager_ProtectedResources.h"

@class XCAccessibilityElement, XCDeviceEvent, XCElementSnapshot, XCSynthesizedEventRecord, XCTCapabilities, XCTSerializedTransportWrapper, XCTSpindumpRequestSpecification, XCUIElementSnapshotRequestResult;

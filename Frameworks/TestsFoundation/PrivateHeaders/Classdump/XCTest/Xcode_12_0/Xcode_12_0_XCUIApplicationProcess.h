...
#endif
#import "Xcode_12_0_XCUIIssueDiagnosticsProviding.h"
#import <Foundation/Foundation.h>

@protocol XCTRunnerAutomationSession, XCUIApplicationProcessDelegate, XCUIDevice;

@class XCAccessibilityElement, XCElementSnapshot, XCTFuture;

...
@class XCAccessibilityElement, XCElementSnapshot, XCTLocalizableStringInfo;
...
@property XCUIUserInterfaceSizeClass verticalSizeClass; // @synthesize verticalSizeClass=_verticalSizeClass;
@property XCUIUserInterfaceSizeClass horizontalSizeClass; // @synthesize horizontalSizeClass=_horizontalSizeClass;
...
@property XCUIElementType elementType; // @synthesize elementType=_elementType;

...
@interface XCAccessibilityElement : NSObject <NSCopying, NSSecureCoding>
{
    ...
    /* unknown type (const struct __AXUIElement) was removed in dump.py */ void *_AXUIElement;
...
+ (id)elementWithAXUIElement:(/* unknown type (struct __AXUIElement) was removed in dump.py */ void *)arg1;
...
@property(readonly) /* unknown type (const struct __AXUIElement) was removed in dump.py */ void *AXUIElement; // @synthesize AXUIElement=_AXUIElement;
...
- (id)description;
- (id)initWithAXUIElement:(/* unknown type (struct __AXUIElement) was removed in dump.py */ void *)arg1 elementType:(unsigned long long)arg2 originPlatform:(unsigned long long)arg3;
